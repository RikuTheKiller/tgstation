...
/// Returns how much blood the blood slime currently holds as a percentage of BLOOD_VOLUME_BLOOD_SLIME_MAXIMUM. (0-1)
/datum/antagonist/blood_slime/proc/get_blood_percentage()
	return get_blood_amount() / BLOOD_VOLUME_BLOOD_SLIME_MAXIMUM
...
/// Adjusts the blood amount of the blood slime by the given percentage. (0-1)
/datum/antagonist/blood_slime/proc/adjust_blood_percentage(percentage, ignore_host_sync)
...
/// Returns how much blood the blood slime's host currently holds as a percentage of BLOOD_VOLUME_BLOOD_SLIME_MAXIMUM. (0-1)
/datum/antagonist/blood_slime/proc/get_host_blood_percentage()
	return get_host_blood_amount() / BLOOD_VOLUME_BLOOD_SLIME_MAXIMUM
