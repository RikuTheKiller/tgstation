...
/obj/structure/girder/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/complex_construction, /datum/construction_controller/girder)
...
/obj/structure/girder/bronze/atom_deconstruct(disassembled = TRUE)
	new /obj/item/stack/sheet/bronze(drop_location(), 2)
