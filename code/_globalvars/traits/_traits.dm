...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	/mob = list(
		...
		"TRAIT_BLOODSLIME_CONTROL" = TRAIT_BLOODSLIME_CONTROL,
		"TRAIT_BLOODSLIME_SUBJUGATION" = TRAIT_BLOODSLIME_SUBJUGATION,
		"TRAIT_BLOODSLIME_MARIONETTE" = TRAIT_BLOODSLIME_MARIONETTE,
		"TRAIT_BLOODSLIME_SYMBIOSIS" = TRAIT_BLOODSLIME_SYMBIOSIS,
