...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	/mob = list(
		...
		"TRAIT_HEMOPARASITE_CONTROL" = TRAIT_HEMOPARASITE_CONTROL,
		"TRAIT_HEMOPARASITE_SUBJUGATION" = TRAIT_HEMOPARASITE_SUBJUGATION,
		"TRAIT_HEMOPARASITE_MARIONETTE" = TRAIT_HEMOPARASITE_MARIONETTE,
		"TRAIT_HEMOPARASITE_SYMBIOSIS" = TRAIT_HEMOPARASITE_SYMBIOSIS,
